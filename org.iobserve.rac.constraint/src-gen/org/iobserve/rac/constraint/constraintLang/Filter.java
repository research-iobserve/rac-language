 ...
 * <ul>
 *   <li>{@link org.iobserve.rac.constraint.constraintLang.Filter#getName <em>Name</em>}</li>
...
public interface Filter extends Operation
{
   ...
   * @see #setName(String)
   * @see org.iobserve.rac.constraint.constraintLang.ConstraintLangPackage#getFilter_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.iobserve.rac.constraint.constraintLang.Filter#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
